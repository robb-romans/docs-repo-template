...
- :ref:`Save key values<save-key-values>`
...
authentication response. :ref:`Save these values<save-key-values>` 
to use when you send requests to the |apiservice|. 
...
``400 Invalid request body: unable to parse Auth data. Please review XML or JSON formatting``
  ...
  If you are using cURL, see the :ref:`cURL Quick Reference<curl-quickref>`.
