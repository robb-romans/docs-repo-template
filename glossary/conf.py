...
html_title = 'Rackspace Glossary'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Glossary'
...
htmlhelp_basename = 'RackspaceGlossary'
...
latex_documents = [
  ('index', 'RackspaceGlossary.tex', 'Rackspace Glossary',
   'Rackspace', 'reference page'),
]
...
man_pages = [
    ('index', 'RackspaceGlossary', 'Rackspace Glossary',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceGlossary', 'Rackspace Metrics Developer Guide',
   'Rackspace', 'RackspaceGlossary', 'Learn about Rackspace-related terms.',
   'Miscellaneous'),
]
